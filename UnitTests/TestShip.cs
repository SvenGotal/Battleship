...
namespace Vsite.Oom.Battleship.Model.UnitTests
{
    ...
    public class TestShip
    {
        ...
        [TestMethod]
        public void HitMethodOnFirstSquareReturnsResultHit()
        {
            {
                Ship ship = new Ship(new List<Square> { new Square(1, 4), new Square(1, 5), new Square(1, 6) });
        ...
        [TestMethod]
        public void HitMethodOnMissedSquareReturnsResultMissed()
        {
            {
                Ship ship = new Ship(new List<Square> { new Square(1, 4), new Square(1, 5), new Square(1, 6) });
        ...
        [TestMethod]
        public void HitMethodOnLastSquareReturnsResultSunk()
        {
            {
                Ship ship = new Ship(new List<Square> { new Square(1, 4), new Square(1, 5), new Square(1, 6) });
                var result = ship.Hit(new Square(1, 5));
