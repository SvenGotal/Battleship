...
namespace Vsite.Oom.Battleship.Model.UnitTests
{
    ...
    {
        [TestMethod]
        public void ToEliminateReturns18SquareAroundTHeShip4_3to4_6()
        {
        ...
        [TestMethod]
        public void ToEliminateReturns8SquareAroundTHeShip0_3to0_4()
        {
            Grid grid = new Grid(10, 10);
            SquareTerminator terminator = new SquareTerminator(grid);
        ...
        [TestMethod]
        public void ToEliminateReturns6SquareAroundTHeShip0_0to0_1()
        {
            Grid grid = new Grid(10, 10);
            SquareTerminator terminator = new SquareTerminator(grid);
        ...
        [TestMethod]
        public void ToEliminateReturns6SquareAroundTHeShip8_9to9_9()
        {
            Grid grid = new Grid(10, 10);
            SquareTerminator terminator = new SquareTerminator(grid);
