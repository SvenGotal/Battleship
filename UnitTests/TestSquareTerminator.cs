...
namespace Vsite.Oom.Battleship.Model.UnitTests
{
    ...
    {
        [TestMethod]
        public void ToEliminateReturns18SquaresAroundTheShipIn4_3to4_6()
        {
        ...
        [TestMethod]
        public void ToEliminateReturns8SquaresAroundTheShipIn0_3to0_4()
        {
            Grid grid = new Grid(10, 10);
            SquareTerminator terminator = new SquareTerminator(grid);
        ...
        [TestMethod]
        public void ToEliminateReturns6SquaresAroundTheShipIn0_0to0_1()
        {
            Grid grid = new Grid(10, 10);
            SquareTerminator terminator = new SquareTerminator(grid);
        ...
        [TestMethod]
        public void ToEliminateReturns6SquaresAroundTheShipIn7_9to9_9()
        {
            Grid grid = new Grid(10, 10);
            SquareTerminator terminator = new SquareTerminator(grid);
            var toEliminate = terminator.ToEliminate(new List<Square> { new Square(4, 3), new Square(4, 4),
