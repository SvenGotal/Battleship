...
namespace Vsite.Oom.Battleship.Model.UnitTests
{
    ...
    public class TestSquareTerminator
    {
        ...
        public void ToEliminateReturns18SquaresAroundTheShip4_3to4_6()
        {
            ...
            SquareTerminator termiantor = new SquareTerminator(grid);
           termiantor.ToEliminate(new List<Square> { new Square(4, 3), new Square(4, 4), new Square(4, 5), new Square(4, 6), });
            var toEliminate = termiantor.ToEliminate(new List<Square> { new Square(4, 3), new Square(4, 4),
        ...
        public void ToEliminateReturns8SquaresAroundTheShip0_3to0_4()
        {
            Grid grid = new Grid(10, 10);
            SquareTerminator termiantor = new SquareTerminator(grid);
            var toEliminate = termiantor.ToEliminate(new List<Square> { new Square(0, 3), new Square(0, 4), });
        ...
        public void ToEliminateReturns6SquaresAroundTheShip0_0to0_1()
        {
            Grid grid = new Grid(10, 10);
            SquareTerminator termiantor = new SquareTerminator(grid);
            var toEliminate = termiantor.ToEliminate(new List<Square> { new Square(0, 0), new Square(0, 1), });
        ...
        public void ToEliminateReturns6SquaresAroundTheShip8_9to9_9()
        {
            Grid grid = new Grid(10, 10);
            SquareTerminator termiantor = new SquareTerminator(grid);
            var toEliminate = termiantor.ToEliminate(new List<Square> { new Square(8, 9), new Square(9, 9), });
            Assert.AreEqual(6, toEliminate.Count());
