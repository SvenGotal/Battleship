...
namespace Vsite.Oom.Battleship.Model.UnitTests
{
    ...
    {
        [TestMethod]
        public void ToEliminateReturns18SquaresArroundTheShip4_3to4_6()
        {
        ...
        [TestMethod]
        public void ToEliminateReturns8SquaresArroundTheShip0_3to0_4()
        {
            Grid grid = new Grid(10, 10);
            SquareTerminator terminator = new SquareTerminator(grid);
        ...
        [TestMethod]
        public void ToEliminateReturns6SquaresArroundTheShip0_0to0_1()
        {
            Grid grid = new Grid(10, 10);
            SquareTerminator terminator = new SquareTerminator(grid);
        ...
        [TestMethod]
        public void ToEliminateReturns6SquaresArroundTheShip8_9to9_9()
        {
            Grid grid = new Grid(10, 10);
            SquareTerminator terminator = new SquareTerminator(grid);
